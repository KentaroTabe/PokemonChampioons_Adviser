...
#
#   bash scripts/start_connection_test.sh              # 通常
#   bash scripts/start_connection_test.sh --with-audit # リアルタイム監査も起動
#
# やること:
