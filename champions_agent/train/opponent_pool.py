...
# 2026-08-25: P1棄却後の登録済み次候補として 0.20→0.30 (P4)。事前登録:
# 主要指標 h2h vs 3_best、ベースライン 0.606 (8/25判定の18,000戦)、
# 9/1 に +0.10 以上かつベンチ同日ペア比較 (アンカー_20260825 vs current)
# が -0.02 以内で採用。詳細は training_changes.json 2026-08-25 20:45
EPSILON_SEARCH = 0.30
